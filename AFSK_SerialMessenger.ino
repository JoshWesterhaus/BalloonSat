...
void setup() {
  ...
  radio.initialize();
  radio.frequency(144415); // default aprs frequency in North America
  radio.setRfPower(0);
...
void loop() {
    if(Serial.available()) { 
      ...
      if(temp == '`') { 
       messagebuff = Serial.readString();
       //Serial.println("Final Buffer: " + messagebuff);
       prepMessage(); 
       msgptr = 0; 
       messagebuff = "";
       //Serial.print("!!");
...
void prepMessage() { 
  //Serial.println("Message is being prepped");
  ...
  Serial.print("From: "); Serial.print(origin_call.c_str()); Serial.print(" To: "); Serial.print(destination_call); Serial.print(" Text: "); Serial.println(textmessage);
